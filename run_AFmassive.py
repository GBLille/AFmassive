...
flags.DEFINE_integer('random_seed', None, 'The random seed for the data '
                     ...
                     'nondeterministic.')
flags.DEFINE_integer('end_prediction', 5, 'How many '
...
flags.DEFINE_integer('start_prediction', 1, 'model to start with, can be used to parallelize jobs, '
                     'e.g --end_prediction 20 --start_prediction 20 will only make model _20'
                     'e.g --end_prediction 21 --start_prediction 20 will make model _20 and _21 etc.')
