...
```
wget https://raw.githubusercontent.com/GBLille/AFmassive/v1.1.7/environment.yml
conda env create -f environment.yml
conda activate AFmassive-1.1.7
...
### Plots
To plot prediction quality graphs, you can use the [massivefold_plots.py](https://github.com/GBLille/MassiveFold/tree/v1.1.7/massivefold) 
